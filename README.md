...
3. **Configure User Data**
   - Click on your istance
   - Click on Actions > Istance settings > Edit user data
   - Before pasting the following bash code, **DON'T FORGET TO MODIFY THE NAME PARAMETERS OF THE S3 BUCKET AND THE WEBSITE FILE:**
  ```bash
#!/bin/bash
...
### **NOTE: The bash code that we previously put into the userdata, on our EC2 Istance,  simplifies these processes**
